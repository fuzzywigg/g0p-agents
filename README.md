...
Dependabot, markdownlint, scratchpad, pyproject tooling, inventory v7 locks
(coverage gate 99%), PR/license/requirements/security/contributing/changelog/
postmortem/gitignore/hydration/execution-summary/implementation-guide,
constitution + routing + negative-constraint surfaces, bug/feature/agent-task
template headings, prompt escalation locks, CI matrix permissions/fail-fast/
artifact naming, and locked four-agent cross-doc consistency):
