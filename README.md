...
Dependabot, markdownlint, scratchpad, pyproject tooling, inventory v8 locks
...
recipe-titles/ci-actions, constitution + routing + negative-constraint surfaces,
bug/feature/agent-task template headings, prompt escalation locks, CI matrix
permissions/fail-fast/artifact naming/action pins, and locked four-agent
