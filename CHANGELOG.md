...
- Contributing guide **v29** deepeners (post-#61): `contributing-local`,
  `contributing-issues`, `contributing-governance` validators; CONTRIBUTING.md
  Local validation (ruff/list-validators/pytest) locks, Issue Reporting
  Bug/Feature/Agent Task locks, and Governance structural-change / routing-matrix
  locks; consistency deepeners for `contributing_local_required_phrases` /
  ...
  implementation guide, agent prompts, goose recipes, README honesty, PR-template,
