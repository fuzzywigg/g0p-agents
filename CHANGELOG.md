...
- Hydration↔security + handoff residual **tests-only** leftover deepeners after
  tip through **#270** (goose-schema leftover after #265) / **#265**
  (Claude/routing leftover after #264) / **#264** (goose-schema leftover after
  #258) / **#258** (hydration/security+handoff leftover after #248) / **#253** /
  **#248** / **#242** / **#236** / **#229** / **#224** / **#219** / **#209**
  ...
  #258 ZWSP/tab/CRLF/fullwidth, first-phrase exact drop matrix for all
  twenty-two, packaging vs locked-* phrase asymmetry and invented/documented
  agent isolation, empty/whitespace/header-only docs and empty/dup/blank/seed
  inventory, null / list-of-int inventory leftovers beyond #258 bool/float,
  `run_all --only` subset, cross-isolation vs #270 goose-schema and #265 Claude/
  routing and #258 siblings, concurrent four-doc races, and tip live-green.
  Historic four only; Packaging inventory unchanged (v52 / 196). Distinct from
  merged #258 (prior hydration/security leftover), #270 (goose-schema), #265
  (Claude/routing), #264 (goose-schema), #253 (prompts+flows), #248
  (actionlint/linkcheck), open CONFLICTING #277 (same leftover vs pre-#270 tip),
  and closed CONFLICTING #252/#247/#241 (same leftover on stale tips).
