...
- Goose-recipe schema + `GOOSE-RECIPES.md` residual **tests-only** leftover
  deepeners after tip through **#258** (hydration/security+handoff leftover after #248) / **#253** (prompts+flows leftover after #248) /
  **#248** / **#242** / **#236** / **#229** / **#224** / **#219** (EXISTING
  ...
  bump; prefer goose-schema niche, not a #258 hydration redo; closed
  ...
  smoke, concurrent races, tip isolation vs #253 prompts+flows and merged #258
  ...
  (prompts+flows), #219 (prior goose-schema leftover), merged #258
  (hydration/security+handoff leftover), and closed CONFLICTING
