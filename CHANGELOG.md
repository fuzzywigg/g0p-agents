...
- Implementation-guide **v41** deepeners (post-#96 constitution v40): `implementation-common-issues`,
  `implementation-faq`, `implementation-support` validators; IMPLEMENTATION-GUIDE.md Common
  Issues & Solutions Issue 1–5 leftover locks, FAQ question/answer leftover locks, and
  Support & Resources / Next Steps / maintainer leftover locks; consistency deepeners for
  `implementation_common_issues_required_phrases` / `implementation_faq_required_phrases` /
  `implementation_support_required_phrases`
  (Packaging inventory 136 total; historic four only — implementation-guide leftovers
  slice, not constitution v40, hydration, security v39, contributing, goose recipes,
  execution-summary, agent prompts, changelog, postmortem, or Dependabot)
