...
- Actionlint/workflow + link-check residual **tests-only** leftover deepeners
  ...
  (CI/markdownlint leftover after #279) / **#279** / **#270** / **#265** /
  **#264** / **#258** / **#253** / **#248** (actionlint/linkcheck leftover after
  #242) / **#242** / **#236** / **#229** / **#224** / **#219** / **#209** /
  **#208** / **#202** / **#200** / **#195** / **#188** (EXISTING seven CI
  fixtures — `ci` / `ci-actions` / `link-check` / `actionlint-shell` /
  `ci-job-names` / `ci-runs-on` / `ci-artifacts` — no invented product /
  inventory bump; prefer actionlint+linkcheck niche, not markdownlint /
  prompts+flows / goose / hydration / Claude-routing): root sequence exact
  equality across seven modules, cancel-false / fail-fast-true bool flips
  (≠ #248 string forms), `on: {}` + `Alpha` branch + group int/null,
  ...
  name null|int, path mapping|bool and upload `with: {}` / if-null, upload-if
  absent and artifact-prefix / matrix-no-py / step-marker drop, drop
  ...
  `run_all --only`, tip-after-#289 deepeners (tab/ideographic/word-joiner +
  figure-space/NNBSP/Mongolian lookalikes, lychee `with:` absent + actionlint
  `steps: []`, concurrency absent + actionlint-only `contents: write`, exact
  dual link+shell Findings, globs list|null + config int and cache-path
  float|bool via `link-check`, isolation vs #289 CI/markdownlint six fixtures,
  triple/quad-surface concurrent races), tip-after-#300 deepeners (isolation
  vs #300 Claude/routing twelve, LS / PS / object-replacement lookalikes
  mirroring #300 Claude theme onto CI yaml, `--only` seven vs #300 twelve +
  invent-key refuse, exact dual link+shell vs Claude live-green, NEL/ZWNBSP
  via link-check+shell, quad-race with #300 Claude live-green), tip isolation
  vs #300/#289/#279/#270/#265/#264/#258/#253/#248/#242/#236 siblings. Historic
  four only; inventory unchanged (v52 / 196). Distinct from merged #300
  (Claude/routing), #289 (CI/markdownlint), #279 (CI/markdownlint), #270
  (goose-schema), #265 (Claude/routing), #264 (goose-schema), #258
  (hydration/security+handoff), #253 (prompts+flows), #248 (after236 leftover
  suite), #242/#236/#229/#195/#188/#186 (prior leftovers), closed CONFLICTING
  #302/#294/#280/#283/#274/#266/#256 (same leftover on pre-#300 / pre-#289 /
  pre-#279 / pre-#270 / pre-#265 / pre-#264 tips), closed CONFLICTING
