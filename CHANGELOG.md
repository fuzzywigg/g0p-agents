...
- Hydration↔security + handoff unsaturated **tests-only** edge deepeners after tip
  ...
  **#195** / **#188** / **#187** / **#186** / **#184** / **#181** (EXISTING
  ...
  `run_all --only` subset isolation, and tip live-green vs #208/#202/#200
  siblings. Historic four only; Packaging inventory unchanged (v52 / 196).
  Distinct from open #209 leftover suite (four-doc isolation / case-BOM /
  inventory-types), merged #208 (goose-schema), #184 (hydration↔security +
