...
- Actionlint/workflow + link-check residual **tests-only** leftover deepeners
  after tip through **#224** (prompts+agentic_flows leftover after #219) /
  **#219** / **#209** / **#208** / **#202** / **#200** / **#195** / **#188**
  ...
  `run_all --only` isolation, tip isolation vs #224/#219/#209 siblings.
  Historic four only; inventory unchanged (v52 / 196). Distinct from merged
  #224 (prompts+flows), #219 (goose-schema), #209 (hydration/handoff),
  #195/#188/#186 (prior actionlint leftovers), closed CONFLICTING
  #226/#218/#215/#211/#206 (same leftover vs stale tips), closed
