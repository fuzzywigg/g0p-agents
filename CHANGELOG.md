...
- CI/markdownlint residual **tests-only** leftover deepeners after tip through
  **#209** (hydration/security+handoff leftover after #208) / **#208** /
  **#202** / **#200** / **#195** / **#188** / **#187** / **#186** (EXISTING six
  ...
  `.markdownlint.yaml` ↔ `schemas/markdownlint.schema.json` required-key + const
  lock parity, per-lock schema const mismatch, YAML structural + type edges
  (root list / string consts / empty nested maps / int-boolish MD025/MD033 /
  MD013 sequence / null consts / MD024 list / float line_length /
  ...
  leftover types, `--only` isolation, concurrent races, and tip isolation
  against #209/#208/#202/#200/#195 siblings. Historic four only; inventory
  unchanged (v52 / 196). Distinct from merged #209 (hydration/security+handoff),
  #208 (goose-schema), #202/#200 (listform+flows), #195/#188/#186
  (actionlint/link-check), #187 (docs-cross), closed CONFLICTING
  #214/#210/#204/#201/#196 (same leftover vs stale tips), and historic v12/v13
