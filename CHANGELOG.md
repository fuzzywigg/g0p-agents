...
- Hydration↔security + handoff unsaturated **tests-only** edge deepeners after tip
  ...
  **#181** (EXISTING twenty-two fixtures — `hydration-phase4` + ten `security*`
  ...
  `run_all --only` subset isolation, and tip live-green vs #219/#209/#208/#202
  siblings. Historic four only; Packaging inventory unchanged (v52 / 196).
  Distinct from merged #209 leftover suite (four-doc isolation / case-BOM /
  inventory-types / concurrent races), closed #222 CONFLICTING relaunch, closed
  #217 RED markdownlint relaunch, closed CONFLICTING #213 tip refill, merged
  #219/#208 (goose-schema), #184 (hydration↔security + goose tip), #181
