...
- Hydration↔security + handoff residual **tests-only** leftover deepeners after
  ...
  **#279** / **#270** / **#265** / **#264** / **#258** (EXISTING twenty-two
  ...
  separator / paragraph separator lookalikes beyond open sibling #309
  soft-hyphen/NBSP/NEL, middle-phrase exact drop matrix (≠ #309 first/last),
  dual invented-agent exact Finding, `security_required_phrases` +
  `scratchpad_required_phrases` inventory leftovers excluded from #309 EMPTY_MAP,
  dict inventory leftovers, mid-BOM lookalikes (leading BOM stays green), multi
  `security-*` simultaneous phrase drops, isolation vs #300 Claude/routing +
  #289 CI/markdownlint, `run_all --only` subset + concurrent four-doc races +
  tip live-green. Historic four only; inventory unchanged (v52 / 196). Distinct
  from open sibling #309 (soft-hyphen/NEL suite), closed CONFLICTING
  #304/#295/#287/#281/#277, merged #300 (Claude/routing), #289/#279
  (CI/markdownlint), #270 (goose-schema), and #258 (hydration/security+handoff).
