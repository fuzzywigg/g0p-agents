...
- CI/markdownlint residual **tests-only** leftover deepeners after tip through
  **#208** (goose-schema leftover after #200) / **#202** / **#200** / **#195** /
  **#188** / **#187** / **#186** (EXISTING six fixtures — `markdownlint` /
  ...
  edges (root list / string consts / empty nested maps / int-boolish MD025/
  MD033 / MD013 sequence), remaining `ci.yml` assertion matrix (setup-python
  cache/with + cache int type, ruff, pip install/check, pytest markers,
  empty/scalar steps), inventory path/schema/yaml drops, `--only` isolation,
  concurrent races, and tip isolation against #208/#202/#200/#195 siblings.
