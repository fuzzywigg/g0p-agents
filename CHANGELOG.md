...
- Prompts listform + agentic_flows residual **tests-only** leftover deepeners after
  tip through **#337** (hydration/security figure leftover after #322) / **#322** (hydration/security+handoff leftover after #307) / **#307**
  ...
  **#296** / **#291** / **#290** / **#284** / **#272** / **#269**; not a
  ...
  #242 int/null, cross isolation vs #322/#307/#300/#289/#279/#270/#265/#264/
  #258/#253/#248 siblings with concurrent races, tip-after-#300 deepeners
  retained (figure-space / NNBSP / Mongolian, LS / PS / object-replacement,
  ...
  quad-surface concurrent races), and tip-after-#322 deepeners (BOM / NBSP /
  word-joiner lookalikes from closed #330, exact dual prompt+security Findings
  mirroring #322 hyd/sec niche, isolation vs #322 hyd/sec twenty-two, `--only`
  nineteen vs #322 hyd invent refuse, quad-surface races vs live hyd/sec,
  live-green), and tip-after-#337 deepeners (isolation vs #337 figure
  twenty-two + invent refuse + live-green vs figure niche). Historic four only; Packaging inventory unchanged (v52 / 196);
  no schema / validators / Dependabot bumps. Distinct from merged #337 (hydration/security figure niche), #322
  (hydration/security+handoff niche), #307 (actionlint/linkcheck niche), #300
  (Claude/routing niche), #289/#279 (CI/markdownlint niches), #270
