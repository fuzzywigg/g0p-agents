...
- Prompts list-form + agentic_flows residual **tests-only** deepeners after tip
  through **#187** (docs-cross) / **#186** (actionlint/link-check) / **#184** /
  **#181** / **#178** / **#176** / **#174** / post-#172 (EXISTING nineteen
  fixtures — twelve list-form sibling `prompt-*` + seven agentic_flows
  `goose` / `recipe-agents` / `recipe-titles` / `scratchpad*` — no invented
  v53 list-form product / inventory bump): invent-key rejection for closed
  ...
  isolation against #187/#186/#184/#181/#178/#176/#174 siblings. Historic four
  only; inventory unchanged (v52 / 196). Distinct from closed CONFLICTING
  #153/#159/#164 (list-form invent), merged #187 (docs-cross tip), #151
  (prompt-pre-v52), #144 (v52 prompt residuals), #181 (memory-handoff), #147
  (goose-recipe), #184 (goose-schema tip), and #186 (actionlint/link-check).
