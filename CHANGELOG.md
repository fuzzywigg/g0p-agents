...
- Security residual **tests-only** deepeners after **#147** (EXISTING ten
  `security` / `security-*` phrase-lock validators only — no invented product /
  ...
  only; inventory unchanged (v52 / 196). Distinct leftover slice from
  goose-recipe #147 and closed CONFLICTING #148/#149/#150.
