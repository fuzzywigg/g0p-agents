...
- Claude/routing governance residual **tests-only** leftover deepeners after tip
  ...
  **#253** / **#248** (EXISTING twelve CLAUDE.md fixtures — `claude` /
  ...
  CONFLICTING **#326** / **#328** / **#319** onto post-#322 tip; no invented
  product / inventory bump): CI `--list-validators` / `--only` / `--json`
  twelve + required Manifest Validate step-marker smoke, exact key-files /
  repo-identity / matrix / rationale Finding equality, escalation-usage vs
  escalation-format isolation (banner vs bracketed usage forms),
  packaging↔repo-identity shared-phrase dual Finding formats, per-metadata
  Tier/Created/Edit/Canonical exact drops, empty-file + directory-not-file
  exact multi-Finding leftovers, inventory type/empty/dup leftovers for
  matrix/metadata/key-files/repo-identity/escalation locks, LRM / ZWJ /
  soft-hyphen / VT / form-feed lookalikes beyond #300/#289 set, simultaneous
  matrix+rationale+metadata triple exact drops, three-agent simultaneous drop
  matrix, concurrent CLAUDE.md races, tip isolation against #322
  hydration/security / #307 actionlint/linkcheck / #300 after289 symbols /
  #289 CI/markdownlint / #270 goose-schema / #265/#264 siblings, tip-after-#322
  deepeners (em-quad / word-joiner / Mongolian-vowel-separator + Ogham-space /
  Braille-blank header lookalikes, simultaneous state+quarterly+negative triple
  exact drops, `--only` twelve vs #322 hydration residual and #307 actionlint
  residual + invent-key refuse). Historic four only; Packaging inventory
  ...
  #326/#328/#319/#293/#282/#271/#278/#260/#192 (same niche on stale tips).
