...
- CI/markdownlint residual **tests-only** leftover deepeners after tip through
  ...
  **#195** / **#188** / **#187** / **#186** (EXISTING six fixtures —
  ...
  absent), tip-after-#270 HEAVY deepeners (isolation vs #270 goose-schema / #265
  Claude/routing / #264/#258/#253/#248 siblings, `--only` subset vs siblings,
  figure-space / NNBSP / Mongolian lookalikes, exact dual md+ruff Findings,
  schema MD013.line_length const mangle, setup-python cache-dependency-path drop
  exact, MD024 null + MD013.tables string / code_blocks int leftovers, ruff +
  pip-install + pytest triple exact, pytest last-marker drop + reorder green,
  inventory pytest-marker type/uniqueness/--cov leftovers, simultaneous
  default+MD025+MD033 exact drops, quad-surface concurrent races, live-green),
  and tip isolation against #270/#265/#264/#258/#253/#248 siblings. Historic four
  only; inventory unchanged (v52 / 196). Distinct from merged #270 (goose-schema
  leftover), #265 (Claude/routing leftover), #264 (goose-schema leftover), #258
  (hydration/security+handoff), #253 (prompts+flows leftover), #248
  (actionlint/linkcheck leftover), open #279 (thin after-#270 tip relaunch),
  closed CONFLICTING
