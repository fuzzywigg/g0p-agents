...
- Claude/routing governance residual **tests-only** leftover deepeners after tip
  through **#300** (Claude/routing leftover after #289) / **#289**
  (CI/markdownlint leftover after #279) / **#279** / **#270** (goose-schema
  leftover after #265) / **#265** / **#264** / **#258** / **#253** / **#248**
  (EXISTING twelve CLAUDE.md fixtures — `claude` / `claude-metadata` /
  `routing` / `routing-matrix` / `routing-rationales` / `repo-identity` /
  ...
  **#300** / **#265** residual; no invented product / inventory bump): CI
  `--list-validators` / `--only` / `--json` twelve + required manifest
  step-marker smoke, exact key-files / repo-identity / matrix / rationale
  Finding equality, escalation-usage vs escalation-format isolation (banner vs
  bracketed usage forms), packaging↔repo-identity shared-phrase dual Finding
  formats, per-metadata Tier/Created/Edit/Canonical exact drops, empty-file +
  directory-not-file exact multi-Finding leftovers, inventory type/empty/dup
  leftovers for matrix/metadata/key-files/repo-identity/escalation locks,
  LRM / ZWJ / soft-hyphen / VT / form-feed lookalikes beyond #300/#289 set,
  ...
  #300 after289 symbols / #289 CI/markdownlint / #270 goose-schema /
  #265/#264 siblings, and `--only` twelve vs invent-key refuse. Historic four
  only; Packaging inventory unchanged (v52 / 196). Distinct from merged #300
  (prior Claude/routing after #289), #289 (CI/markdownlint), #279, #270
  (goose-schema), #265 (prior Claude/routing), #264/#258/#253/#248 siblings,
  and closed CONFLICTING #293/#282/#271/#278/#260/#192 (same niche on stale
  tips).
