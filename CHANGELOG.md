...
- Actionlint/workflow + link-check residual **tests-only** leftover deepeners
  after tip through **#264** (goose-schema leftover after #258) / **#258** /
  **#253** / **#248** (actionlint/linkcheck leftover after #242) / **#242** /
  ...
  **#200** / **#195** / **#188** (EXISTING seven CI fixtures — `ci` /
  ...
  hydration): root sequence exact equality across seven modules, cancel-false /
  fail-fast-true bool flips (≠ #248 string forms), `on: {}` + `Alpha` branch +
  group int/null, permissions scalar + non-dict `link-check: true` green/fail
  ...
  #256 (same leftover on pre-#264 tip), closed CONFLICTING
