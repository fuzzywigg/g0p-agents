...
# ---------------------------------------------------------------------------
# Goose-recipe SCHEMA + Security residual HEAVY edges after #161 tip.
...
# phrase locks), merged #151 (prompt-pre-v52), merged #156 (constitution),
# merged #161 (hydration), and closed CONFLICTING #155/#158/#165 security
# residual drafts on older tips.
# ---------------------------------------------------------------------------
