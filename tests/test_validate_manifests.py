...
# (agent-handoff edges) / goose-security #165 / #173 tip refill.
# ---------------------------------------------------------------------------
...
def test_memory_handoff_residual_modules_existing_only() -> None:
    """Slice targets eleven existing memory/handoff modules — not #156/#161/#166/#172/#174/#176."""
