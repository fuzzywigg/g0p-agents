        ...
        ("markdownlint_default", False),
            ...
            (
                ...
                (
                    ...
                    list(vm.PROMPT_INTEGRATION_REQUIRED_PHRASES)[:-1] + ["invented"],
                ),
                (
...
def test_live_v50_prompt_responsibilities_cannot_delegate_integration_validators() -> None:
...
def test_v50_prompt_responsibilities_cannot_delegate_integration_edge_cases(
    tmp_path: Path,
) -> None:
    for fn in [
